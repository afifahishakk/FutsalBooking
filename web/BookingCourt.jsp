        ...
        <div id="main" class="wrapper style1">
            <div class="container">
                <div class="well" id="wellhome">
                    ...
                    <fieldset>
                        <div class="container">
                            <form method ="post" action = "RequestBookingServlet">
                                <h1><b>Booking Information</b></h1>
                                <div class="form-group">
                                    <label for="bookDate" class="col-lg-3 control-label">Court ID</label>
                                    <div class="input-group date"  >
                                        <input type="text" class="form-control" id="courtID" readonly  name="courtID" value="${param.courtID}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="bookDate" class="col-lg-3 control-label">Court Type</label>
                                    <div class="input-group date" >
                                        <input type="text" class="form-control" id="courttype" readonly  name="courtType" value="${param.courtName}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="bookDate" class="col-lg-3 control-label">Court Name</label>
                                    <div class="input-group date" >
                                        <input type="text" class="form-control" id="courtname" readonly name="courtName" value="${param.courtType}">
                                    </div>
                                </div>
